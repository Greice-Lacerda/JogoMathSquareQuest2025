document.addEventListener('DOMContentLoaded', function() {
    ...
    const clapSound = new Audio('../sons/Aplausos.mp3'); // Caminho para o som de aplausos
    const imagens = ['../imagens/abelha.jpeg', '../imagens/bispo.jpeg', '../imagens/bola.jpeg', '../imagens/carro.jpeg', 
                     '../imagens/cavalo.jpeg', '../imagens/circulo.jpeg', '../imagens/coração.png',
                     '../imagens/estrela.jpeg', '../imagens/flor.jpeg', '../imagens/peao.jpeg', 
                     '../imagens/quadrado.jpeg', '../imagens/Rainha.jpeg', '../imagens/Rei.jpeg', 
                     '../imagens/torre.jpeg', '../imagens/triangulo.jpeg'];
    ...
    const tamanho = 2; //parseInt(getParametroUrl('tamanhoTabuleiro')) || 2; // Obtém o tamanho do tabuleiro da URL ou usa 2 como padrão
    embaralhar(imagens);
    ...
    canvas.addEventListener('drop', function(event) {
        ...
        const scale = canvas.width / rect.width; // Calcula a escala atual do canvas
